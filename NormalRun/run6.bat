...
python trainer.py --dataset "cifar10" --params "utils/cifar10_params.yaml" --aggregation_rule "flame" --device "cuda:1" --attack_mode "MR" || echo Error ignored
@REM python trainer.py --dataset "cifar10" --params "utils/cifar10_params.yaml" --aggregation_rule "flame" --device "cuda:1" --attack_mode "MR" || echo Error ignored
@REM python trainer.py --dataset "cifar10" --params "utils/cifar10_params.yaml" --aggregation_rule "flame" --device "cuda:1" --attack_mode "MR" || echo Error ignored

python trainer.py --dataset "cifar10" --params "utils/cifar10_params.yaml" --aggregation_rule "flame" --device "cuda:1" --attack_mode "EDGE_CASE" || echo Error ignored
