'''
Author: LetMeFly
Date: 2024-09-10 02:35:55
LastEditors: LetMeFly
LastEditTime: 2024-09-10 02:36:52
'''
import numpy as np
...
# 生成模拟数据
def generate_simulated_data(num_clients=20, num_features=100, T=10):
    clients_data = {}
...
# 生成模拟数据
clients_data = generate_simulated_data(num_clients=20, num_features=100, T=10)
